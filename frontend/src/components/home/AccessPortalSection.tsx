  ...
  return (
    <section id="access-portal" className="relative py-32 overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 text-center">
        <span className="inline-block py-1 px-3 rounded-full bg-white/10 text-white/90 text-xs font-bold tracking-widest uppercase mb-4 border border-white/20">{t('accessPortal.tag')}</span>
        <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">{t('accessPortal.title')}</h2>
        <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-16">{t('accessPortal.subtitle')}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-3xl hover:-translate-y-2 hover:bg-white/15 transition-all duration-300 text-left shadow-2xl">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">{t('accessPortal.citizens.title')}</h3>
            <p className="text-gray-300 mb-8 h-20">{t('accessPortal.citizens.desc')}</p>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-3xl hover:-translate-y-2 hover:bg-white/15 transition-all duration-300 text-left shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 p-3 bg-[#8B1A2F] text-xs font-bold text-white rounded-bl-2xl tracking-wider">{t('accessPortal.police.restricted')}</div>
            ...
            <h3 className="text-2xl font-bold text-white mb-3">{t('accessPortal.police.title')}</h3>
            <p className="text-gray-300 mb-8 h-20">{t('accessPortal.police.desc')}</p>
            <button onClick={() => navigate('/login')} className="w-full py-3.5 bg-white/10 border border-white/20 text-white font-bold rounded-xl hover:bg-white/20 transition-colors">
              {t('accessPortal.police.btn')}
            </button>
          </div>

          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-3xl hover:-translate-y-2 hover:bg-white/15 transition-all duration-300 text-left shadow-2xl relative overflow-hidden">
             <div className="absolute top-0 right-0 p-3 bg-gray-600/80 text-xs font-bold text-white rounded-bl-2xl tracking-wider">{t('accessPortal.admin.adminOnly')}</div>
            ...
            <h3 className="text-2xl font-bold text-white mb-3">{t('accessPortal.admin.title')}</h3>
            <p className="text-gray-300 mb-8 h-20">{t('accessPortal.admin.desc')}</p>
            <button onClick={() => navigate('/login')} className="w-full py-3.5 bg-white/10 border border-white/20 text-white font-bold rounded-xl hover:bg-white/20 transition-colors">
              {t('accessPortal.admin.btn')}
            </button>
          </div>
